   ...
   a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  1e:	6a 02                	push   $0x2
  20:	e8 2b 06 00 00       	call   650 <fprintf>
    exit();
  ...
  4e:	6a 02                	push   $0x2
  50:	e8 fb 05 00 00       	call   650 <fprintf>
 ...
 36c:	89 d1                	mov    %edx,%ecx
{
 ...
 399:	0f b6 92 a0 08 00 00 	movzbl 0x8a0(%edx),%edx
...
static void vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 471:	ff 24 85 48 08 00 00 	jmp    *0x848(,%eax,4)
 ...
 5a8:	c1 e8 1c             	shr    $0x1c,%eax
  write(fd, &c, 1);
 5ab:	6a 01                	push   $0x1
 5ad:	0f b6 80 a0 08 00 00 	movzbl 0x8a0(%eax),%eax
 ...
 63e:	e9 7d fe ff ff       	jmp    4c0 <vprintf+0xb0>
          s = "(null)";
 643:	bf 3f 08 00 00       	mov    $0x83f,%edi
        while(*s != 0){
...
free(void *ap)
{
 ...
 691:	a1 b4 08 00 00       	mov    0x8b4,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 b4 08 00 00    	mov    %edx,0x8b4
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 b4 08 00 00    	mov    %edx,0x8b4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d b4 08 00 00    	mov    0x8b4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d b4 08 00 00    	mov    0x8b4,%edi
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 b4 08 00 00    	mov    0x8b4,%edx
 ...
 7cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 b4 08 00 00    	mov    %edx,0x8b4
}
 ...
 7df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 b4 08 00 00 b8 	movl   $0x8b8,0x8b4
 7e7:	08 00 00 
    base.s.size = 0;
 7ea:	bf b8 08 00 00       	mov    $0x8b8,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 b8 08 00 00 b8 	movl   $0x8b8,0x8b8
 7f6:	08 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 bc 08 00 00 00 	movl   $0x0,0x8bc
 802:	00 00 00 
    if(p->s.size >= nunits){
