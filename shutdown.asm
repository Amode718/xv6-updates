...
int main(int argc, char *argv[]){
  ...
  30:	e8 4b 06 00 00       	call   680 <printf>
    if(fork()==0){
  35:	e8 81 02 00 00       	call   2bb <fork>
  ...
  49:	e8 05 03 00 00       	call   353 <sleep>

        cpuhalt();
  4e:	e8 10 03 00 00       	call   363 <cpuhalt>
    }
    else{
        exit();
    }
  ...
  5c:	c3                   	ret    
        cpuhalt();
  5d:	e8 01 03 00 00       	call   363 <cpuhalt>
 ...
 37c:	89 d1                	mov    %edx,%ecx
{
 ...
 3a9:	0f b6 92 a8 08 00 00 	movzbl 0x8a8(%edx),%edx
...
static void vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 481:	ff 24 85 50 08 00 00 	jmp    *0x850(,%eax,4)
 ...
 5b8:	c1 e8 1c             	shr    $0x1c,%eax
  write(fd, &c, 1);
 5bb:	6a 01                	push   $0x1
 5bd:	0f b6 80 a8 08 00 00 	movzbl 0x8a8(%eax),%eax
 ...
 64e:	e9 7d fe ff ff       	jmp    4d0 <vprintf+0xb0>
          s = "(null)";
 653:	bf 49 08 00 00       	mov    $0x849,%edi
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a1:	a1 bc 08 00 00       	mov    0x8bc,%eax
{
 ...
 6e1:	5b                   	pop    %ebx
  freep = p;
 6e2:	89 15 bc 08 00 00    	mov    %edx,0x8bc
}
 6e8:	5e                   	pop    %esi
 6e9:	5f                   	pop    %edi
 6ea:	5d                   	pop    %ebp
 ...
 719:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 71c:	89 15 bc 08 00 00    	mov    %edx,0x8bc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 3d bc 08 00 00    	mov    0x8bc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77f:	73 4f                	jae    7d0 <malloc+0xa0>
    ...
    if(p == freep)
 781:	8b 3d bc 08 00 00    	mov    0x8bc,%edi
 ...
 7aa:	e8 f1 fe ff ff       	call   6a0 <free>
  return freep;
 7af:	8b 15 bc 08 00 00    	mov    0x8bc,%edx
 ...
 7dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7df:	89 15 bc 08 00 00    	mov    %edx,0x8bc
}
 ...
 7ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 bc 08 00 00 c0 	movl   $0x8c0,0x8bc
 7f7:	08 00 00 
    base.s.size = 0;
 7fa:	bf c0 08 00 00       	mov    $0x8c0,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 c0 08 00 00 c0 	movl   $0x8c0,0x8c0
 806:	08 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 80b:	c7 05 c4 08 00 00 00 	movl   $0x0,0x8c4
 812:	00 00 00 
    if(p->s.size >= nunits){
