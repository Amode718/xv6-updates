...
main(int argc, char *argv[])
{
  ...
  2c:	74 23                	je     51 <main+0x51>
  2e:	66 90                	xchg   %ax,%ax
  30:	83 ec 04             	sub    $0x4,%esp
  33:	83 c3 01             	add    $0x1,%ebx
  36:	68 28 08 00 00       	push   $0x828
  3b:	50                   	push   %eax
  3c:	68 2a 08 00 00       	push   $0x82a
  41:	e8 3a 06 00 00       	call   680 <printf>
  46:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  4a:	83 c4 10             	add    $0x10,%esp
  4d:	39 f3                	cmp    %esi,%ebx
  4f:	75 df                	jne    30 <main+0x30>
  51:	83 ec 04             	sub    $0x4,%esp
  54:	68 2f 08 00 00       	push   $0x82f
  59:	50                   	push   %eax
  5a:	68 2a 08 00 00       	push   $0x82a
  5f:	e8 1c 06 00 00       	call   680 <printf>
 ...
 37c:	89 d1                	mov    %edx,%ecx
{
 ...
 3a9:	0f b6 92 90 08 00 00 	movzbl 0x890(%edx),%edx
...
static void vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 481:	ff 24 85 38 08 00 00 	jmp    *0x838(,%eax,4)
 ...
 5b8:	c1 e8 1c             	shr    $0x1c,%eax
  write(fd, &c, 1);
 5bb:	6a 01                	push   $0x1
 5bd:	0f b6 80 90 08 00 00 	movzbl 0x890(%eax),%eax
 ...
 64e:	e9 7d fe ff ff       	jmp    4d0 <vprintf+0xb0>
          s = "(null)";
 653:	bf 31 08 00 00       	mov    $0x831,%edi
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a1:	a1 a4 08 00 00       	mov    0x8a4,%eax
{
 ...
 6e1:	5b                   	pop    %ebx
  freep = p;
 6e2:	89 15 a4 08 00 00    	mov    %edx,0x8a4
}
 6e8:	5e                   	pop    %esi
 6e9:	5f                   	pop    %edi
 6ea:	5d                   	pop    %ebp
 ...
 719:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 71c:	89 15 a4 08 00 00    	mov    %edx,0x8a4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 3d a4 08 00 00    	mov    0x8a4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77f:	73 4f                	jae    7d0 <malloc+0xa0>
    ...
    if(p == freep)
 781:	8b 3d a4 08 00 00    	mov    0x8a4,%edi
 ...
 7aa:	e8 f1 fe ff ff       	call   6a0 <free>
  return freep;
 7af:	8b 15 a4 08 00 00    	mov    0x8a4,%edx
 ...
 7dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7df:	89 15 a4 08 00 00    	mov    %edx,0x8a4
}
 ...
 7ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 a4 08 00 00 a8 	movl   $0x8a8,0x8a4
 7f7:	08 00 00 
    base.s.size = 0;
 7fa:	bf a8 08 00 00       	mov    $0x8a8,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 a8 08 00 00 a8 	movl   $0x8a8,0x8a8
 806:	08 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 80b:	c7 05 ac 08 00 00 00 	movl   $0x0,0x8ac
 812:	00 00 00 
    if(p->s.size >= nunits){
