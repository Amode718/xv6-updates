...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 67 58 10 80 	movl   $0x80105867,0x14(%eax)
  p->context = (struct context*)sp;
...
80103dac:	8d 70 2c             	lea    0x2c(%eax),%esi
80103daf:	8d 78 6c             	lea    0x6c(%eax),%edi
...
80103f95:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103f9c:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
...
801041e9:	bb c4 1d 11 80       	mov    $0x80111dc4,%ebx
...
8010420b:	81 fb c4 3d 11 80    	cmp    $0x80113dc4,%ebx
80104211:	0f 84 81 00 00 00    	je     80104298 <procdump+0xb8>
    if(p->state == UNUSED)
80104217:	8b 43 9c             	mov    -0x64(%ebx),%eax
...
8010425b:	8b 43 ac             	mov    -0x54(%ebx),%eax
...
80104c98:	8b 74 90 2c          	mov    0x2c(%eax,%edx,4),%esi
...
80104cb0:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
...
80104cd0:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80104cd3:	89 74 98 2c          	mov    %esi,0x2c(%eax,%ebx,4)
  filedup(f);
...
80104d18:	8b 74 90 2c          	mov    0x2c(%eax,%edx,4),%esi
...
80104d98:	8b 74 90 2c          	mov    0x2c(%eax,%edx,4),%esi
...
80104e1b:	8b 74 98 0c          	mov    0xc(%eax,%ebx,4),%esi
...
80104e28:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80104e2b:	c7 44 98 0c 00 00 00 	movl   $0x0,0xc(%eax,%ebx,4)
80104e32:	00 
  fileclose(f);
...
80104e78:	8b 74 90 2c          	mov    0x2c(%eax,%edx,4),%esi
...
801055fe:	66 90                	xchg   %ax,%ax
    if(curproc->ofile[fd] == 0){
80105600:	8b 74 98 2c          	mov    0x2c(%eax,%ebx,4),%esi
...
8010566e:	66 90                	xchg   %ax,%ax
      curproc->ofile[fd] = f;
80105670:	89 7c 90 2c          	mov    %edi,0x2c(%eax,%edx,4)
  }
  fd[0] = fd0;
...
80105840 <sys_cpuhalt>:
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105840:	b8 00 20 00 00       	mov    $0x2000,%eax
80105845:	ba 04 06 00 00       	mov    $0x604,%edx
...
80105850:	06                   	push   %es
  pushl %fs
80105851:	0f a0                	push   %fs
  pushl %gs
80105853:	0f a8                	push   %gs
  pushal
80105855:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105856:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010585a:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010585c:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
8010585e:	54                   	push   %esp
  call trap
8010585f:	e8 cc 00 00 00       	call   80105930 <trap>
  addl $4, %esp
80105864:	83 c4 04             	add    $0x4,%esp
...
80105867:	61                   	popa   
  popl %gs
80105868:	0f a9                	pop    %gs
  popl %fs
8010586a:	0f a1                	pop    %fs
  popl %es
8010586c:	07                   	pop    %es
  popl %ds
8010586d:	1f                   	pop    %ds
...
8010586e:	83 c4 08             	add    $0x8,%esp
  iret
80105871:	cf                   	iret   
80105872:	66 90                	xchg   %ax,%ax
80105874:	66 90                	xchg   %ax,%ax
...
80105897:	c7 04 c5 c2 3d 11 80 	movl   $0x8e000008,-0x7feec23e(,%eax,8)
8010589e:	08 00 00 8e 
801058a2:	66 89 14 c5 c0 3d 11 	mov    %dx,-0x7feec240(,%eax,8)
801058a9:	80 
801058aa:	c1 ea 10             	shr    $0x10,%edx
801058ad:	66 89 14 c5 c6 3d 11 	mov    %dx,-0x7feec23a(,%eax,8)
801058b4:	80 
  for(i = 0; i < 256; i++)
...
801058c7:	c7 05 c2 3f 11 80 08 	movl   $0xef000008,0x80113fc2
801058ce:	00 00 ef 
  initlock(&tickslock, "time");
801058d1:	68 5d 79 10 80       	push   $0x8010795d
801058d6:	68 80 3d 11 80       	push   $0x80113d80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801058db:	66 a3 c0 3f 11 80    	mov    %ax,0x80113fc0
801058e1:	c1 e8 10             	shr    $0x10,%eax
801058e4:	66 a3 c6 3f 11 80    	mov    %ax,0x80113fc6
  initlock(&tickslock, "time");
...
8010590b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010590f:	b8 c0 3d 11 80       	mov    $0x80113dc0,%eax
...
80105954:	ff 24 85 04 7a 10 80 	jmp    *-0x7fef85fc(,%eax,4)
...
80105a2e:	83 c6 70             	add    $0x70,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105a31:	56                   	push   %esi
80105a32:	ff 70 10             	push   0x10(%eax)
80105a35:	68 c0 79 10 80       	push   $0x801079c0
...
80105a87:	68 68 79 10 80       	push   $0x80107968
...
80105b40:	68 80 3d 11 80       	push   $0x80113d80
80105b45:	e8 56 ea ff ff       	call   801045a0 <acquire>
      wakeup(&ticks);
80105b4a:	c7 04 24 60 3d 11 80 	movl   $0x80113d60,(%esp)
      ticks++;
80105b51:	83 05 60 3d 11 80 01 	addl   $0x1,0x80113d60
      wakeup(&ticks);
80105b58:	e8 a3 e5 ff ff       	call   80104100 <wakeup>
      release(&tickslock);
80105b5d:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
...
80105ba3:	68 8c 79 10 80       	push   $0x8010798c
80105ba8:	e8 f3 aa ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105bad:	83 c4 14             	add    $0x14,%esp
80105bb0:	68 62 79 10 80       	push   $0x80107962
...
{
  if(!uart)
80105bc0:	a1 c0 45 11 80       	mov    0x801145c0,%eax
...
80105c47:	0f 84 93 00 00 00    	je     80105ce0 <uartinit+0xf0>
  uart = 1;
80105c4d:	c7 05 c0 45 11 80 01 	movl   $0x1,0x801145c0
80105c54:	00 00 00 
...
80105c60:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105c63:	bf 84 7a 10 80       	mov    $0x80107a84,%edi
80105c68:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80105c6d:	6a 00                	push   $0x0
80105c6f:	6a 04                	push   $0x4
80105c71:	e8 0a c8 ff ff       	call   80102480 <ioapicenable>
80105c76:	c6 45 e7 76          	movb   $0x76,-0x19(%ebp)
80105c7a:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
80105c7d:	c6 45 e6 78          	movb   $0x78,-0x1a(%ebp)
80105c81:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105c88:	a1 c0 45 11 80       	mov    0x801145c0,%eax
80105c8d:	bb 80 00 00 00       	mov    $0x80,%ebx
80105c92:	85 c0                	test   %eax,%eax
80105c94:	75 1c                	jne    80105cb2 <uartinit+0xc2>
80105c96:	eb 2b                	jmp    80105cc3 <uartinit+0xd3>
...
80105cb0:	74 07                	je     80105cb9 <uartinit+0xc9>
80105cb2:	89 f2                	mov    %esi,%edx
80105cb4:	ec                   	in     (%dx),%al
80105cb5:	a8 20                	test   $0x20,%al
80105cb7:	74 e7                	je     80105ca0 <uartinit+0xb0>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105cb9:	0f b6 45 e6          	movzbl -0x1a(%ebp),%eax
80105cbd:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105cc2:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
80105cc3:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
80105cc7:	83 c7 01             	add    $0x1,%edi
80105cca:	84 c0                	test   %al,%al
80105ccc:	74 12                	je     80105ce0 <uartinit+0xf0>
80105cce:	88 45 e6             	mov    %al,-0x1a(%ebp)
80105cd1:	0f b6 47 01          	movzbl 0x1(%edi),%eax
80105cd5:	88 45 e7             	mov    %al,-0x19(%ebp)
80105cd8:	eb ae                	jmp    80105c88 <uartinit+0x98>
...
80105d56:	68 c0 5b 10 80       	push   $0x80105bc0
...
80105d67:	6a 00                	push   $0x0
  jmp alltraps
80105d69:	e9 e1 fa ff ff       	jmp    8010584f <alltraps>
...
80105d70:	6a 01                	push   $0x1
  jmp alltraps
80105d72:	e9 d8 fa ff ff       	jmp    8010584f <alltraps>
...
80105d79:	6a 02                	push   $0x2
  jmp alltraps
80105d7b:	e9 cf fa ff ff       	jmp    8010584f <alltraps>
...
80105d82:	6a 03                	push   $0x3
  jmp alltraps
80105d84:	e9 c6 fa ff ff       	jmp    8010584f <alltraps>
...
80105d8b:	6a 04                	push   $0x4
  jmp alltraps
80105d8d:	e9 bd fa ff ff       	jmp    8010584f <alltraps>
...
80105d94:	6a 05                	push   $0x5
  jmp alltraps
80105d96:	e9 b4 fa ff ff       	jmp    8010584f <alltraps>
...
80105d9d:	6a 06                	push   $0x6
  jmp alltraps
80105d9f:	e9 ab fa ff ff       	jmp    8010584f <alltraps>
...
80105da6:	6a 07                	push   $0x7
  jmp alltraps
80105da8:	e9 a2 fa ff ff       	jmp    8010584f <alltraps>
...
80105dad:	6a 08                	push   $0x8
  jmp alltraps
80105daf:	e9 9b fa ff ff       	jmp    8010584f <alltraps>
...
80105db6:	6a 09                	push   $0x9
  jmp alltraps
80105db8:	e9 92 fa ff ff       	jmp    8010584f <alltraps>
...
80105dbd:	6a 0a                	push   $0xa
  jmp alltraps
80105dbf:	e9 8b fa ff ff       	jmp    8010584f <alltraps>
...
80105dc4:	6a 0b                	push   $0xb
  jmp alltraps
80105dc6:	e9 84 fa ff ff       	jmp    8010584f <alltraps>
...
80105dcb:	6a 0c                	push   $0xc
  jmp alltraps
80105dcd:	e9 7d fa ff ff       	jmp    8010584f <alltraps>
...
80105dd2:	6a 0d                	push   $0xd
  jmp alltraps
80105dd4:	e9 76 fa ff ff       	jmp    8010584f <alltraps>
...
80105dd9:	6a 0e                	push   $0xe
  jmp alltraps
80105ddb:	e9 6f fa ff ff       	jmp    8010584f <alltraps>
...
80105de2:	6a 0f                	push   $0xf
  jmp alltraps
80105de4:	e9 66 fa ff ff       	jmp    8010584f <alltraps>
...
80105deb:	6a 10                	push   $0x10
  jmp alltraps
80105ded:	e9 5d fa ff ff       	jmp    8010584f <alltraps>
...
80105df2:	6a 11                	push   $0x11
  jmp alltraps
80105df4:	e9 56 fa ff ff       	jmp    8010584f <alltraps>
...
80105dfb:	6a 12                	push   $0x12
  jmp alltraps
80105dfd:	e9 4d fa ff ff       	jmp    8010584f <alltraps>
...
80105e04:	6a 13                	push   $0x13
  jmp alltraps
80105e06:	e9 44 fa ff ff       	jmp    8010584f <alltraps>
...
80105e0d:	6a 14                	push   $0x14
  jmp alltraps
80105e0f:	e9 3b fa ff ff       	jmp    8010584f <alltraps>
...
80105e16:	6a 15                	push   $0x15
  jmp alltraps
80105e18:	e9 32 fa ff ff       	jmp    8010584f <alltraps>
...
80105e1f:	6a 16                	push   $0x16
  jmp alltraps
80105e21:	e9 29 fa ff ff       	jmp    8010584f <alltraps>
...
80105e28:	6a 17                	push   $0x17
  jmp alltraps
80105e2a:	e9 20 fa ff ff       	jmp    8010584f <alltraps>
...
80105e31:	6a 18                	push   $0x18
  jmp alltraps
80105e33:	e9 17 fa ff ff       	jmp    8010584f <alltraps>
...
80105e3a:	6a 19                	push   $0x19
  jmp alltraps
80105e3c:	e9 0e fa ff ff       	jmp    8010584f <alltraps>
...
80105e43:	6a 1a                	push   $0x1a
  jmp alltraps
80105e45:	e9 05 fa ff ff       	jmp    8010584f <alltraps>
...
80105e4c:	6a 1b                	push   $0x1b
  jmp alltraps
80105e4e:	e9 fc f9 ff ff       	jmp    8010584f <alltraps>
...
80105e55:	6a 1c                	push   $0x1c
  jmp alltraps
80105e57:	e9 f3 f9 ff ff       	jmp    8010584f <alltraps>
...
80105e5e:	6a 1d                	push   $0x1d
  jmp alltraps
80105e60:	e9 ea f9 ff ff       	jmp    8010584f <alltraps>
...
80105e67:	6a 1e                	push   $0x1e
  jmp alltraps
80105e69:	e9 e1 f9 ff ff       	jmp    8010584f <alltraps>
...
80105e70:	6a 1f                	push   $0x1f
  jmp alltraps
80105e72:	e9 d8 f9 ff ff       	jmp    8010584f <alltraps>
...
80105e79:	6a 20                	push   $0x20
  jmp alltraps
80105e7b:	e9 cf f9 ff ff       	jmp    8010584f <alltraps>
...
80105e82:	6a 21                	push   $0x21
  jmp alltraps
80105e84:	e9 c6 f9 ff ff       	jmp    8010584f <alltraps>
...
80105e8b:	6a 22                	push   $0x22
  jmp alltraps
80105e8d:	e9 bd f9 ff ff       	jmp    8010584f <alltraps>
...
80105e94:	6a 23                	push   $0x23
  jmp alltraps
80105e96:	e9 b4 f9 ff ff       	jmp    8010584f <alltraps>
...
80105e9d:	6a 24                	push   $0x24
  jmp alltraps
80105e9f:	e9 ab f9 ff ff       	jmp    8010584f <alltraps>
...
80105ea6:	6a 25                	push   $0x25
  jmp alltraps
80105ea8:	e9 a2 f9 ff ff       	jmp    8010584f <alltraps>
...
80105eaf:	6a 26                	push   $0x26
  jmp alltraps
80105eb1:	e9 99 f9 ff ff       	jmp    8010584f <alltraps>
...
80105eb8:	6a 27                	push   $0x27
  jmp alltraps
80105eba:	e9 90 f9 ff ff       	jmp    8010584f <alltraps>
...
80105ec1:	6a 28                	push   $0x28
  jmp alltraps
80105ec3:	e9 87 f9 ff ff       	jmp    8010584f <alltraps>
...
80105eca:	6a 29                	push   $0x29
  jmp alltraps
80105ecc:	e9 7e f9 ff ff       	jmp    8010584f <alltraps>
...
80105ed3:	6a 2a                	push   $0x2a
  jmp alltraps
80105ed5:	e9 75 f9 ff ff       	jmp    8010584f <alltraps>
...
80105edc:	6a 2b                	push   $0x2b
  jmp alltraps
80105ede:	e9 6c f9 ff ff       	jmp    8010584f <alltraps>
...
80105ee5:	6a 2c                	push   $0x2c
  jmp alltraps
80105ee7:	e9 63 f9 ff ff       	jmp    8010584f <alltraps>
...
80105eee:	6a 2d                	push   $0x2d
  jmp alltraps
80105ef0:	e9 5a f9 ff ff       	jmp    8010584f <alltraps>
...
80105ef7:	6a 2e                	push   $0x2e
  jmp alltraps
80105ef9:	e9 51 f9 ff ff       	jmp    8010584f <alltraps>
...
80105f00:	6a 2f                	push   $0x2f
  jmp alltraps
80105f02:	e9 48 f9 ff ff       	jmp    8010584f <alltraps>
...
80105f09:	6a 30                	push   $0x30
  jmp alltraps
80105f0b:	e9 3f f9 ff ff       	jmp    8010584f <alltraps>
...
80105f12:	6a 31                	push   $0x31
  jmp alltraps
80105f14:	e9 36 f9 ff ff       	jmp    8010584f <alltraps>
...
80105f1b:	6a 32                	push   $0x32
  jmp alltraps
80105f1d:	e9 2d f9 ff ff       	jmp    8010584f <alltraps>
...
80105f24:	6a 33                	push   $0x33
  jmp alltraps
80105f26:	e9 24 f9 ff ff       	jmp    8010584f <alltraps>
...
80105f2d:	6a 34                	push   $0x34
  jmp alltraps
80105f2f:	e9 1b f9 ff ff       	jmp    8010584f <alltraps>
...
80105f36:	6a 35                	push   $0x35
  jmp alltraps
80105f38:	e9 12 f9 ff ff       	jmp    8010584f <alltraps>
...
80105f3f:	6a 36                	push   $0x36
  jmp alltraps
80105f41:	e9 09 f9 ff ff       	jmp    8010584f <alltraps>
...
80105f48:	6a 37                	push   $0x37
  jmp alltraps
80105f4a:	e9 00 f9 ff ff       	jmp    8010584f <alltraps>
...
80105f51:	6a 38                	push   $0x38
  jmp alltraps
80105f53:	e9 f7 f8 ff ff       	jmp    8010584f <alltraps>
...
80105f5a:	6a 39                	push   $0x39
  jmp alltraps
80105f5c:	e9 ee f8 ff ff       	jmp    8010584f <alltraps>
...
80105f63:	6a 3a                	push   $0x3a
  jmp alltraps
80105f65:	e9 e5 f8 ff ff       	jmp    8010584f <alltraps>
...
80105f6c:	6a 3b                	push   $0x3b
  jmp alltraps
80105f6e:	e9 dc f8 ff ff       	jmp    8010584f <alltraps>
...
80105f75:	6a 3c                	push   $0x3c
  jmp alltraps
80105f77:	e9 d3 f8 ff ff       	jmp    8010584f <alltraps>
...
80105f7e:	6a 3d                	push   $0x3d
  jmp alltraps
80105f80:	e9 ca f8 ff ff       	jmp    8010584f <alltraps>
...
80105f87:	6a 3e                	push   $0x3e
  jmp alltraps
80105f89:	e9 c1 f8 ff ff       	jmp    8010584f <alltraps>
...
80105f90:	6a 3f                	push   $0x3f
  jmp alltraps
80105f92:	e9 b8 f8 ff ff       	jmp    8010584f <alltraps>
...
80105f99:	6a 40                	push   $0x40
  jmp alltraps
80105f9b:	e9 af f8 ff ff       	jmp    8010584f <alltraps>
...
80105fa2:	6a 41                	push   $0x41
  jmp alltraps
80105fa4:	e9 a6 f8 ff ff       	jmp    8010584f <alltraps>
...
80105fab:	6a 42                	push   $0x42
  jmp alltraps
80105fad:	e9 9d f8 ff ff       	jmp    8010584f <alltraps>
...
80105fb4:	6a 43                	push   $0x43
  jmp alltraps
80105fb6:	e9 94 f8 ff ff       	jmp    8010584f <alltraps>
...
80105fbd:	6a 44                	push   $0x44
  jmp alltraps
80105fbf:	e9 8b f8 ff ff       	jmp    8010584f <alltraps>
...
80105fc6:	6a 45                	push   $0x45
  jmp alltraps
80105fc8:	e9 82 f8 ff ff       	jmp    8010584f <alltraps>
...
80105fcf:	6a 46                	push   $0x46
  jmp alltraps
80105fd1:	e9 79 f8 ff ff       	jmp    8010584f <alltraps>
...
80105fd8:	6a 47                	push   $0x47
  jmp alltraps
80105fda:	e9 70 f8 ff ff       	jmp    8010584f <alltraps>
...
80105fe1:	6a 48                	push   $0x48
  jmp alltraps
80105fe3:	e9 67 f8 ff ff       	jmp    8010584f <alltraps>
...
80105fea:	6a 49                	push   $0x49
  jmp alltraps
80105fec:	e9 5e f8 ff ff       	jmp    8010584f <alltraps>
...
80105ff3:	6a 4a                	push   $0x4a
  jmp alltraps
80105ff5:	e9 55 f8 ff ff       	jmp    8010584f <alltraps>
...
80105ffc:	6a 4b                	push   $0x4b
  jmp alltraps
80105ffe:	e9 4c f8 ff ff       	jmp    8010584f <alltraps>
...
80106005:	6a 4c                	push   $0x4c
  jmp alltraps
80106007:	e9 43 f8 ff ff       	jmp    8010584f <alltraps>
...
8010600e:	6a 4d                	push   $0x4d
  jmp alltraps
80106010:	e9 3a f8 ff ff       	jmp    8010584f <alltraps>
...
80106017:	6a 4e                	push   $0x4e
  jmp alltraps
80106019:	e9 31 f8 ff ff       	jmp    8010584f <alltraps>
...
80106020:	6a 4f                	push   $0x4f
  jmp alltraps
80106022:	e9 28 f8 ff ff       	jmp    8010584f <alltraps>
...
80106029:	6a 50                	push   $0x50
  jmp alltraps
8010602b:	e9 1f f8 ff ff       	jmp    8010584f <alltraps>
...
80106032:	6a 51                	push   $0x51
  jmp alltraps
80106034:	e9 16 f8 ff ff       	jmp    8010584f <alltraps>
...
8010603b:	6a 52                	push   $0x52
  jmp alltraps
8010603d:	e9 0d f8 ff ff       	jmp    8010584f <alltraps>
...
80106044:	6a 53                	push   $0x53
  jmp alltraps
80106046:	e9 04 f8 ff ff       	jmp    8010584f <alltraps>
...
8010604d:	6a 54                	push   $0x54
  jmp alltraps
8010604f:	e9 fb f7 ff ff       	jmp    8010584f <alltraps>
...
80106056:	6a 55                	push   $0x55
  jmp alltraps
80106058:	e9 f2 f7 ff ff       	jmp    8010584f <alltraps>
...
8010605f:	6a 56                	push   $0x56
  jmp alltraps
80106061:	e9 e9 f7 ff ff       	jmp    8010584f <alltraps>
...
80106068:	6a 57                	push   $0x57
  jmp alltraps
8010606a:	e9 e0 f7 ff ff       	jmp    8010584f <alltraps>
...
80106071:	6a 58                	push   $0x58
  jmp alltraps
80106073:	e9 d7 f7 ff ff       	jmp    8010584f <alltraps>
...
8010607a:	6a 59                	push   $0x59
  jmp alltraps
8010607c:	e9 ce f7 ff ff       	jmp    8010584f <alltraps>
...
80106083:	6a 5a                	push   $0x5a
  jmp alltraps
80106085:	e9 c5 f7 ff ff       	jmp    8010584f <alltraps>
...
8010608c:	6a 5b                	push   $0x5b
  jmp alltraps
8010608e:	e9 bc f7 ff ff       	jmp    8010584f <alltraps>
...
80106095:	6a 5c                	push   $0x5c
  jmp alltraps
80106097:	e9 b3 f7 ff ff       	jmp    8010584f <alltraps>
...
8010609e:	6a 5d                	push   $0x5d
  jmp alltraps
801060a0:	e9 aa f7 ff ff       	jmp    8010584f <alltraps>
...
801060a7:	6a 5e                	push   $0x5e
  jmp alltraps
801060a9:	e9 a1 f7 ff ff       	jmp    8010584f <alltraps>
...
801060b0:	6a 5f                	push   $0x5f
  jmp alltraps
801060b2:	e9 98 f7 ff ff       	jmp    8010584f <alltraps>
...
801060b9:	6a 60                	push   $0x60
  jmp alltraps
801060bb:	e9 8f f7 ff ff       	jmp    8010584f <alltraps>
...
801060c2:	6a 61                	push   $0x61
  jmp alltraps
801060c4:	e9 86 f7 ff ff       	jmp    8010584f <alltraps>
...
801060cb:	6a 62                	push   $0x62
  jmp alltraps
801060cd:	e9 7d f7 ff ff       	jmp    8010584f <alltraps>
...
801060d4:	6a 63                	push   $0x63
  jmp alltraps
801060d6:	e9 74 f7 ff ff       	jmp    8010584f <alltraps>
...
801060dd:	6a 64                	push   $0x64
  jmp alltraps
801060df:	e9 6b f7 ff ff       	jmp    8010584f <alltraps>
...
801060e6:	6a 65                	push   $0x65
  jmp alltraps
801060e8:	e9 62 f7 ff ff       	jmp    8010584f <alltraps>
...
801060ef:	6a 66                	push   $0x66
  jmp alltraps
801060f1:	e9 59 f7 ff ff       	jmp    8010584f <alltraps>
...
801060f8:	6a 67                	push   $0x67
  jmp alltraps
801060fa:	e9 50 f7 ff ff       	jmp    8010584f <alltraps>
...
80106101:	6a 68                	push   $0x68
  jmp alltraps
80106103:	e9 47 f7 ff ff       	jmp    8010584f <alltraps>
...
8010610a:	6a 69                	push   $0x69
  jmp alltraps
8010610c:	e9 3e f7 ff ff       	jmp    8010584f <alltraps>
...
80106113:	6a 6a                	push   $0x6a
  jmp alltraps
80106115:	e9 35 f7 ff ff       	jmp    8010584f <alltraps>
...
8010611c:	6a 6b                	push   $0x6b
  jmp alltraps
8010611e:	e9 2c f7 ff ff       	jmp    8010584f <alltraps>
...
80106125:	6a 6c                	push   $0x6c
  jmp alltraps
80106127:	e9 23 f7 ff ff       	jmp    8010584f <alltraps>
...
8010612e:	6a 6d                	push   $0x6d
  jmp alltraps
80106130:	e9 1a f7 ff ff       	jmp    8010584f <alltraps>
...
80106137:	6a 6e                	push   $0x6e
  jmp alltraps
80106139:	e9 11 f7 ff ff       	jmp    8010584f <alltraps>
...
80106140:	6a 6f                	push   $0x6f
  jmp alltraps
80106142:	e9 08 f7 ff ff       	jmp    8010584f <alltraps>
...
80106149:	6a 70                	push   $0x70
  jmp alltraps
8010614b:	e9 ff f6 ff ff       	jmp    8010584f <alltraps>
...
80106152:	6a 71                	push   $0x71
  jmp alltraps
80106154:	e9 f6 f6 ff ff       	jmp    8010584f <alltraps>
...
8010615b:	6a 72                	push   $0x72
  jmp alltraps
8010615d:	e9 ed f6 ff ff       	jmp    8010584f <alltraps>
...
80106164:	6a 73                	push   $0x73
  jmp alltraps
80106166:	e9 e4 f6 ff ff       	jmp    8010584f <alltraps>
...
8010616d:	6a 74                	push   $0x74
  jmp alltraps
8010616f:	e9 db f6 ff ff       	jmp    8010584f <alltraps>
...
80106176:	6a 75                	push   $0x75
  jmp alltraps
80106178:	e9 d2 f6 ff ff       	jmp    8010584f <alltraps>
...
8010617f:	6a 76                	push   $0x76
  jmp alltraps
80106181:	e9 c9 f6 ff ff       	jmp    8010584f <alltraps>
...
80106188:	6a 77                	push   $0x77
  jmp alltraps
8010618a:	e9 c0 f6 ff ff       	jmp    8010584f <alltraps>
...
80106191:	6a 78                	push   $0x78
  jmp alltraps
80106193:	e9 b7 f6 ff ff       	jmp    8010584f <alltraps>
...
8010619a:	6a 79                	push   $0x79
  jmp alltraps
8010619c:	e9 ae f6 ff ff       	jmp    8010584f <alltraps>
...
801061a3:	6a 7a                	push   $0x7a
  jmp alltraps
801061a5:	e9 a5 f6 ff ff       	jmp    8010584f <alltraps>
...
801061ac:	6a 7b                	push   $0x7b
  jmp alltraps
801061ae:	e9 9c f6 ff ff       	jmp    8010584f <alltraps>
...
801061b5:	6a 7c                	push   $0x7c
  jmp alltraps
801061b7:	e9 93 f6 ff ff       	jmp    8010584f <alltraps>
...
801061be:	6a 7d                	push   $0x7d
  jmp alltraps
801061c0:	e9 8a f6 ff ff       	jmp    8010584f <alltraps>
...
801061c7:	6a 7e                	push   $0x7e
  jmp alltraps
801061c9:	e9 81 f6 ff ff       	jmp    8010584f <alltraps>
...
801061d0:	6a 7f                	push   $0x7f
  jmp alltraps
801061d2:	e9 78 f6 ff ff       	jmp    8010584f <alltraps>
...
801061d9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801061de:	e9 6c f6 ff ff       	jmp    8010584f <alltraps>
...
801061e5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801061ea:	e9 60 f6 ff ff       	jmp    8010584f <alltraps>
...
801061f1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801061f6:	e9 54 f6 ff ff       	jmp    8010584f <alltraps>
...
801061fd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106202:	e9 48 f6 ff ff       	jmp    8010584f <alltraps>
...
80106209:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010620e:	e9 3c f6 ff ff       	jmp    8010584f <alltraps>
...
80106215:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010621a:	e9 30 f6 ff ff       	jmp    8010584f <alltraps>
...
80106221:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106226:	e9 24 f6 ff ff       	jmp    8010584f <alltraps>
...
8010622d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106232:	e9 18 f6 ff ff       	jmp    8010584f <alltraps>
...
80106239:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010623e:	e9 0c f6 ff ff       	jmp    8010584f <alltraps>
...
80106245:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010624a:	e9 00 f6 ff ff       	jmp    8010584f <alltraps>
...
80106251:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106256:	e9 f4 f5 ff ff       	jmp    8010584f <alltraps>
...
8010625d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106262:	e9 e8 f5 ff ff       	jmp    8010584f <alltraps>
...
80106269:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010626e:	e9 dc f5 ff ff       	jmp    8010584f <alltraps>
...
80106275:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010627a:	e9 d0 f5 ff ff       	jmp    8010584f <alltraps>
...
80106281:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106286:	e9 c4 f5 ff ff       	jmp    8010584f <alltraps>
...
8010628d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106292:	e9 b8 f5 ff ff       	jmp    8010584f <alltraps>
...
80106299:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010629e:	e9 ac f5 ff ff       	jmp    8010584f <alltraps>
...
801062a5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801062aa:	e9 a0 f5 ff ff       	jmp    8010584f <alltraps>
...
801062b1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801062b6:	e9 94 f5 ff ff       	jmp    8010584f <alltraps>
...
801062bd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801062c2:	e9 88 f5 ff ff       	jmp    8010584f <alltraps>
...
801062c9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801062ce:	e9 7c f5 ff ff       	jmp    8010584f <alltraps>
...
801062d5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801062da:	e9 70 f5 ff ff       	jmp    8010584f <alltraps>
...
801062e1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801062e6:	e9 64 f5 ff ff       	jmp    8010584f <alltraps>
...
801062ed:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801062f2:	e9 58 f5 ff ff       	jmp    8010584f <alltraps>
...
801062f9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801062fe:	e9 4c f5 ff ff       	jmp    8010584f <alltraps>
...
80106305:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010630a:	e9 40 f5 ff ff       	jmp    8010584f <alltraps>
...
80106311:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106316:	e9 34 f5 ff ff       	jmp    8010584f <alltraps>
...
8010631d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106322:	e9 28 f5 ff ff       	jmp    8010584f <alltraps>
...
80106329:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010632e:	e9 1c f5 ff ff       	jmp    8010584f <alltraps>
...
80106335:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010633a:	e9 10 f5 ff ff       	jmp    8010584f <alltraps>
...
80106341:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106346:	e9 04 f5 ff ff       	jmp    8010584f <alltraps>
...
8010634d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106352:	e9 f8 f4 ff ff       	jmp    8010584f <alltraps>
...
80106359:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010635e:	e9 ec f4 ff ff       	jmp    8010584f <alltraps>
...
80106365:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010636a:	e9 e0 f4 ff ff       	jmp    8010584f <alltraps>
...
80106371:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106376:	e9 d4 f4 ff ff       	jmp    8010584f <alltraps>
...
8010637d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106382:	e9 c8 f4 ff ff       	jmp    8010584f <alltraps>
...
80106389:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010638e:	e9 bc f4 ff ff       	jmp    8010584f <alltraps>
...
80106395:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010639a:	e9 b0 f4 ff ff       	jmp    8010584f <alltraps>
...
801063a1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801063a6:	e9 a4 f4 ff ff       	jmp    8010584f <alltraps>
...
801063ad:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801063b2:	e9 98 f4 ff ff       	jmp    8010584f <alltraps>
...
801063b9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801063be:	e9 8c f4 ff ff       	jmp    8010584f <alltraps>
...
801063c5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801063ca:	e9 80 f4 ff ff       	jmp    8010584f <alltraps>
...
801063d1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801063d6:	e9 74 f4 ff ff       	jmp    8010584f <alltraps>
...
801063dd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801063e2:	e9 68 f4 ff ff       	jmp    8010584f <alltraps>
...
801063e9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801063ee:	e9 5c f4 ff ff       	jmp    8010584f <alltraps>
...
801063f5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801063fa:	e9 50 f4 ff ff       	jmp    8010584f <alltraps>
...
80106401:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106406:	e9 44 f4 ff ff       	jmp    8010584f <alltraps>
...
8010640d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106412:	e9 38 f4 ff ff       	jmp    8010584f <alltraps>
...
80106419:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010641e:	e9 2c f4 ff ff       	jmp    8010584f <alltraps>
...
80106425:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010642a:	e9 20 f4 ff ff       	jmp    8010584f <alltraps>
...
80106431:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106436:	e9 14 f4 ff ff       	jmp    8010584f <alltraps>
...
8010643d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106442:	e9 08 f4 ff ff       	jmp    8010584f <alltraps>
...
80106449:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010644e:	e9 fc f3 ff ff       	jmp    8010584f <alltraps>
...
80106455:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010645a:	e9 f0 f3 ff ff       	jmp    8010584f <alltraps>
...
80106461:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106466:	e9 e4 f3 ff ff       	jmp    8010584f <alltraps>
...
8010646d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106472:	e9 d8 f3 ff ff       	jmp    8010584f <alltraps>
...
80106479:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010647e:	e9 cc f3 ff ff       	jmp    8010584f <alltraps>
...
80106485:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010648a:	e9 c0 f3 ff ff       	jmp    8010584f <alltraps>
...
80106491:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106496:	e9 b4 f3 ff ff       	jmp    8010584f <alltraps>
...
8010649d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801064a2:	e9 a8 f3 ff ff       	jmp    8010584f <alltraps>
...
801064a9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801064ae:	e9 9c f3 ff ff       	jmp    8010584f <alltraps>
...
801064b5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801064ba:	e9 90 f3 ff ff       	jmp    8010584f <alltraps>
...
801064c1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801064c6:	e9 84 f3 ff ff       	jmp    8010584f <alltraps>
...
801064cd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801064d2:	e9 78 f3 ff ff       	jmp    8010584f <alltraps>
...
801064d9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801064de:	e9 6c f3 ff ff       	jmp    8010584f <alltraps>
...
801064e5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801064ea:	e9 60 f3 ff ff       	jmp    8010584f <alltraps>
...
801064f1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801064f6:	e9 54 f3 ff ff       	jmp    8010584f <alltraps>
...
801064fd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106502:	e9 48 f3 ff ff       	jmp    8010584f <alltraps>
...
80106509:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010650e:	e9 3c f3 ff ff       	jmp    8010584f <alltraps>
...
80106515:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010651a:	e9 30 f3 ff ff       	jmp    8010584f <alltraps>
...
80106521:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106526:	e9 24 f3 ff ff       	jmp    8010584f <alltraps>
...
8010652d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106532:	e9 18 f3 ff ff       	jmp    8010584f <alltraps>
...
80106539:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010653e:	e9 0c f3 ff ff       	jmp    8010584f <alltraps>
...
80106545:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010654a:	e9 00 f3 ff ff       	jmp    8010584f <alltraps>
...
80106551:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106556:	e9 f4 f2 ff ff       	jmp    8010584f <alltraps>
...
8010655d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106562:	e9 e8 f2 ff ff       	jmp    8010584f <alltraps>
...
80106569:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010656e:	e9 dc f2 ff ff       	jmp    8010584f <alltraps>
...
80106575:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010657a:	e9 d0 f2 ff ff       	jmp    8010584f <alltraps>
...
80106581:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106586:	e9 c4 f2 ff ff       	jmp    8010584f <alltraps>
...
8010658d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106592:	e9 b8 f2 ff ff       	jmp    8010584f <alltraps>
...
80106599:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010659e:	e9 ac f2 ff ff       	jmp    8010584f <alltraps>
...
801065a5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801065aa:	e9 a0 f2 ff ff       	jmp    8010584f <alltraps>
...
801065b1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801065b6:	e9 94 f2 ff ff       	jmp    8010584f <alltraps>
...
801065bd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801065c2:	e9 88 f2 ff ff       	jmp    8010584f <alltraps>
...
801065c9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801065ce:	e9 7c f2 ff ff       	jmp    8010584f <alltraps>
...
801065d5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801065da:	e9 70 f2 ff ff       	jmp    8010584f <alltraps>
...
801065e1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801065e6:	e9 64 f2 ff ff       	jmp    8010584f <alltraps>
...
801065ed:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801065f2:	e9 58 f2 ff ff       	jmp    8010584f <alltraps>
...
801065f9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801065fe:	e9 4c f2 ff ff       	jmp    8010584f <alltraps>
...
80106605:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010660a:	e9 40 f2 ff ff       	jmp    8010584f <alltraps>
...
80106611:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106616:	e9 34 f2 ff ff       	jmp    8010584f <alltraps>
...
8010661d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106622:	e9 28 f2 ff ff       	jmp    8010584f <alltraps>
...
80106629:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010662e:	e9 1c f2 ff ff       	jmp    8010584f <alltraps>
...
80106635:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010663a:	e9 10 f2 ff ff       	jmp    8010584f <alltraps>
...
80106641:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106646:	e9 04 f2 ff ff       	jmp    8010584f <alltraps>
...
8010664d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106652:	e9 f8 f1 ff ff       	jmp    8010584f <alltraps>
...
80106659:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010665e:	e9 ec f1 ff ff       	jmp    8010584f <alltraps>
...
80106665:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010666a:	e9 e0 f1 ff ff       	jmp    8010584f <alltraps>
...
80106671:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106676:	e9 d4 f1 ff ff       	jmp    8010584f <alltraps>
...
8010667d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106682:	e9 c8 f1 ff ff       	jmp    8010584f <alltraps>
...
80106689:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010668e:	e9 bc f1 ff ff       	jmp    8010584f <alltraps>
...
80106695:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010669a:	e9 b0 f1 ff ff       	jmp    8010584f <alltraps>
...
801066a1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801066a6:	e9 a4 f1 ff ff       	jmp    8010584f <alltraps>
...
801066ad:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801066b2:	e9 98 f1 ff ff       	jmp    8010584f <alltraps>
...
801066b9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801066be:	e9 8c f1 ff ff       	jmp    8010584f <alltraps>
...
801066c5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801066ca:	e9 80 f1 ff ff       	jmp    8010584f <alltraps>
...
801066d1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801066d6:	e9 74 f1 ff ff       	jmp    8010584f <alltraps>
...
801066dd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801066e2:	e9 68 f1 ff ff       	jmp    8010584f <alltraps>
...
801066e9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801066ee:	e9 5c f1 ff ff       	jmp    8010584f <alltraps>
...
801066f5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801066fa:	e9 50 f1 ff ff       	jmp    8010584f <alltraps>
...
80106701:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106706:	e9 44 f1 ff ff       	jmp    8010584f <alltraps>
...
8010670d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106712:	e9 38 f1 ff ff       	jmp    8010584f <alltraps>
...
80106719:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010671e:	e9 2c f1 ff ff       	jmp    8010584f <alltraps>
...
80106725:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010672a:	e9 20 f1 ff ff       	jmp    8010584f <alltraps>
...
80106731:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106736:	e9 14 f1 ff ff       	jmp    8010584f <alltraps>
...
8010673d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106742:	e9 08 f1 ff ff       	jmp    8010584f <alltraps>
...
80106749:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010674e:	e9 fc f0 ff ff       	jmp    8010584f <alltraps>
...
80106755:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010675a:	e9 f0 f0 ff ff       	jmp    8010584f <alltraps>
...
80106761:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106766:	e9 e4 f0 ff ff       	jmp    8010584f <alltraps>
...
8010676d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106772:	e9 d8 f0 ff ff       	jmp    8010584f <alltraps>
...
80106779:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010677e:	e9 cc f0 ff ff       	jmp    8010584f <alltraps>
...
80106785:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010678a:	e9 c0 f0 ff ff       	jmp    8010584f <alltraps>
...
80106791:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106796:	e9 b4 f0 ff ff       	jmp    8010584f <alltraps>
...
8010679d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801067a2:	e9 a8 f0 ff ff       	jmp    8010584f <alltraps>
...
801067a9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801067ae:	e9 9c f0 ff ff       	jmp    8010584f <alltraps>
...
801067b5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801067ba:	e9 90 f0 ff ff       	jmp    8010584f <alltraps>
...
801067c1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801067c6:	e9 84 f0 ff ff       	jmp    8010584f <alltraps>
...
801067cd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801067d2:	e9 78 f0 ff ff       	jmp    8010584f <alltraps>
...
80106a10:	a1 c4 45 11 80       	mov    0x801145c4,%eax
...
80106f0b:	a3 c4 45 11 80       	mov    %eax,0x801145c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
