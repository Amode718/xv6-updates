...
main(int argc, char *argv[])
{
  ...
  3b:	50                   	push   %eax
  3c:	68 0a 08 00 00       	push   $0x80a
  41:	e8 1a 06 00 00       	call   660 <printf>
  46:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  4a:	83 c4 10             	add    $0x10,%esp
  4d:	39 f3                	cmp    %esi,%ebx
  4f:	75 df                	jne    30 <main+0x30>
  51:	83 ec 04             	sub    $0x4,%esp
  54:	68 0f 08 00 00       	push   $0x80f
  59:	50                   	push   %eax
  5a:	68 0a 08 00 00       	push   $0x80a
  5f:	e8 fc 05 00 00       	call   660 <printf>
...
printint(int fd, int xx, int base, int sgn)
 ...
 3a9:	0f b6 92 70 08 00 00 	movzbl 0x870(%edx),%edx
 ...
 429:	89 55 d4             	mov    %edx,-0x2c(%ebp)
{
 ...
 47f:	ff 24 85 18 08 00 00 	jmp    *0x818(,%eax,4)
 ...
 58a:	c1 e8 1c             	shr    $0x1c,%eax
  write(fd, &c, 1);
 58d:	56                   	push   %esi
 58e:	0f b6 80 70 08 00 00 	movzbl 0x870(%eax),%eax
 595:	6a 01                	push   $0x1
 ...
 626:	e9 a3 fe ff ff       	jmp    4ce <vprintf.constprop.0+0xae>
          s = "(null)";
 62b:	bf 11 08 00 00       	mov    $0x811,%edi
        while(*s != 0){
...
free(void *ap)
{
 ...
 681:	a1 84 08 00 00       	mov    0x884,%eax
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	89 15 84 08 00 00    	mov    %edx,0x884
}
 6c8:	5e                   	pop    %esi
 6c9:	5f                   	pop    %edi
 6ca:	5d                   	pop    %ebp
 ...
 6f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6fc:	89 15 84 08 00 00    	mov    %edx,0x884
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 3d 84 08 00 00    	mov    0x884,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 4f                	jae    7b0 <malloc+0xa0>
    ...
    if(p == freep)
 761:	8b 3d 84 08 00 00    	mov    0x884,%edi
 ...
 78a:	e8 f1 fe ff ff       	call   680 <free>
  return freep;
 78f:	8b 15 84 08 00 00    	mov    0x884,%edx
 ...
 7bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 84 08 00 00    	mov    %edx,0x884
}
 ...
 7cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 84 08 00 00 88 	movl   $0x888,0x884
 7d7:	08 00 00 
    base.s.size = 0;
 7da:	bf 88 08 00 00       	mov    $0x888,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 88 08 00 00 88 	movl   $0x888,0x888
 7e6:	08 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7eb:	c7 05 8c 08 00 00 00 	movl   $0x0,0x88c
 7f2:	00 00 00 
    if(p->s.size >= nunits){
