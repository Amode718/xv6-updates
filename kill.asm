...
main(int argc, char **argv)
{
  ...
  51:	6a 02                	push   $0x2
  53:	e8 f8 05 00 00       	call   650 <fprintf>
    exit();
 ...
 36c:	89 d1                	mov    %edx,%ecx
{
 ...
 399:	0f b6 92 8c 08 00 00 	movzbl 0x88c(%edx),%edx
...
static void vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 471:	ff 24 85 34 08 00 00 	jmp    *0x834(,%eax,4)
 ...
 5a8:	c1 e8 1c             	shr    $0x1c,%eax
  write(fd, &c, 1);
 5ab:	6a 01                	push   $0x1
 5ad:	0f b6 80 8c 08 00 00 	movzbl 0x88c(%eax),%eax
 ...
 63e:	e9 7d fe ff ff       	jmp    4c0 <vprintf+0xb0>
          s = "(null)";
 643:	bf 2c 08 00 00       	mov    $0x82c,%edi
        while(*s != 0){
...
free(void *ap)
{
 ...
 691:	a1 a0 08 00 00       	mov    0x8a0,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 a0 08 00 00    	mov    %edx,0x8a0
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 a0 08 00 00    	mov    %edx,0x8a0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d a0 08 00 00    	mov    0x8a0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d a0 08 00 00    	mov    0x8a0,%edi
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 a0 08 00 00    	mov    0x8a0,%edx
 ...
 7cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 a0 08 00 00    	mov    %edx,0x8a0
}
 ...
 7df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 a0 08 00 00 a4 	movl   $0x8a4,0x8a0
 7e7:	08 00 00 
    base.s.size = 0;
 7ea:	bf a4 08 00 00       	mov    $0x8a4,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 a4 08 00 00 a4 	movl   $0x8a4,0x8a4
 7f6:	08 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 a8 08 00 00 00 	movl   $0x0,0x8a8
 802:	00 00 00 
    if(p->s.size >= nunits){
